...
export const PROMPTS = [
  ...
  'why did my taxes take six hours',
  "grandma's 90th birthday this weekend",
  'lost my wallet on the train',
  'the kids are asleep and the house is silent',
  'won trivia night by one point',
  ...
  'heatwave outside and the office AC is broken',
  ...
  'found twenty bucks in an old coat',
  'car failed its inspection, again',
  'planted tomatoes, hoping for the best',
  'no notes. perfect show.',
  'is it too early for a glass of wine',
  'power went out mid-game and I was winning',
  'my package says delivered but there is nothing here',
  'got the last seat on the last train home',
  'the espresso machine at work finally got fixed',
];
